...
def player_ranks(year, pos, weeks):
    ...
    # print(tabulate.tabulate(Pt_rank, headers = "keys"))
    # #print tabulate.tabulate(PL_rank, headers = "keys")
    # a = 0
    # print("Player Percent Rankings: P1, P2, P3, P4, total points, and std_dev (QB and TE top 5, RB and WR top 12)")
    # print('')
    # for key, value in sorted(PL_rank.iteritems(), key=lambda (k,v): (v,k), reverse=True):
    #     a = a + 1
